...
class PartiesPeersonalPage extends StatefulWidget {
  const PartiesPeersonalPage({super.key});

  @override
  State<PartiesPeersonalPage> createState() => _PartiesPeersonalPageState();
}

class _PartiesPeersonalPageState extends State<PartiesPeersonalPage> {
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border(
                            bottom: BorderSide(
                              color: selectedButton == 'حول الحزب'
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border(
                            bottom: BorderSide(
                              color: selectedButton == 'اعضاء الحزب'
                                  ? const Color(0xff2E8F5A)
                                  : Colors.transparent,
                              width: 3,
                            ),
            ...
            Expanded(
              child: Padding(
                ...
                child: SingleChildScrollView(
                  child: selectedButton == 'حول الحزب'
                      ? Column(
